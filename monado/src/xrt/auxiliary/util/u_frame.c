...
u_frame_clone(struct xrt_frame *to_copy, struct xrt_frame **out_frame)
{
	...
	xf->host_exposure_ns = to_copy->host_exposure_ns;
	xf->host_transfer_complete_ns = to_copy->host_transfer_complete_ns;
	xf->host_driver_pushed_ns = to_copy->host_driver_pushed_ns;
	xf->host_source_received_ns = to_copy->host_source_received_ns;
	xf->host_source_pushed_ns = to_copy->host_source_pushed_ns;
...
u_frame_create_roi(struct xrt_frame *original, struct xrt_rect roi, struct xrt_frame **out_frame)
{
	...
	xf->host_exposure_ns = original->host_exposure_ns;
	xf->host_transfer_complete_ns = original->host_transfer_complete_ns;
	xf->host_driver_pushed_ns = original->host_driver_pushed_ns;
	xf->host_source_received_ns = original->host_source_received_ns;
	xf->host_source_pushed_ns = original->host_source_pushed_ns;
